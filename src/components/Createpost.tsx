...
export default function Creatpost()
{
    ...
    const [context , setcontext] = useState<string>('')
     const [branch , setDept] = useState<string>('')
      const [ section, setSection] = useState<string>('')

    const {mutate} = useMutation({mutationFn: creatpost})
    ...
    <div>
        <label htmlFor="contex" className="block text-sm font-medium text-white">
        Body
        </label>
        <textarea
        id="contex"
  ...
  <div className="flex space-x-4">
    ...
    <div className="flex-1">
      <label htmlFor="department"className="block text-sm font-medium text-white  placeholder-gray-400">
        Department
      </label>
   

      <div id="department" className="mt-1 w-full rounded-lg border border-gray-300 p-2  focus:border-blue-500 focus:ring-2 focus:ring-blue-500 outline-none text-white">
        {branch}
